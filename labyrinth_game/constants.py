...
ROOMS = {
    ...
    'skeleton_room': {
        'description': 'Тёмная жуткая комната. Повсюду лежат кости и черепа. Ощущение, будто вы в этой комнате не один.',
        'exits': {'west': 'trap_room'},
        'items': [],
        'puzzle': ('Вы чувствуете холодное дыхание у вас за спиной.\nОбернувшись, вы видите ожившего скелета с саблей в одной руке и большим ключом в другой.\nОн спрашивает вас о том, сколько было времени в момент, когда проклятие окутало это место\n(ответ дайте в формате hh:mm).', '01:40')
    }
}
