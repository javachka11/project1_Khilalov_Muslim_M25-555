...
ROOMS = {
    ...
    'library': {
        ...
        'exits': {'east': 'hall', 'north': 'armory', 'south': 'dining_room', 'west': 'spider_room'},
        'items': ['ancient_book'],
    ...
    'dining_room': {
        'description': 'Столовая. На стене поломанные часы, стрелки показывают без двадцати два ночи. Посередине огромный длинный стол. На нём лежит бочонок с элем.',
        'exits': {'east': 'entrance', 'north': 'library'},
        'items': ['ale_keg'],
        'puzzle': None
    },
    'spider_room': {
        'description': 'Тёмная комната, наполненная пауками. Большое их скопление окружило пьедестал в середине комнаты. На пьедестале яркий рубиновый клинок.',
        'exits': {'east': 'library'},
        'items': ['ruby_blade'],
        'puzzle': ('Вы чувствуете холодное дыхание у вас за спиной. Устрашающий голос спрашивает вас о том, сколько было времени в момент, когда проклятие окутало это место (ответ дайте в формате hh:mm).', '01:40')
    }
}
